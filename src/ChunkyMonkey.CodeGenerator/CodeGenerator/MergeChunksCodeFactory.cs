...
namespace ChunkyMonkey.CodeGenerator.CodeGenerator
{
    internal class MergeChunksCodeFactory
    {
        ...
        internal string ForHashSetProperty(PropertyInfo propertyInfo, TypeRule typeRule)
        {
            var newInstanceCommand = typeRule.NewInstance(propertyInfo);
        ...
        internal string ForSortedSetProperty(PropertyInfo propertyInfo, TypeRule typeRule)
        {
            var newInstanceCommand = typeRule.NewInstance(propertyInfo);
